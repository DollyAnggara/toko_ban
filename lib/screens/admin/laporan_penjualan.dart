...
class AdminLaporanPenjualanScreen extends StatefulWidget {
  final UserModel user;
  const AdminLaporanPenjualanScreen({required this.user, super.key});

  @override
  State<AdminLaporanPenjualanScreen> createState() =>
      _AdminLaporanPenjualanScreenState();
}

class _AdminLaporanPenjualanScreenState
    extends State<AdminLaporanPenjualanScreen> {
  ...
  bool _inRange(DateTime d) {
    if (_start != null &&
        d.isBefore(_start!.subtract(const Duration(days: 1)))) {
      return false;
    }
