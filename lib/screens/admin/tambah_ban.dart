...
class AdminTambahBan extends StatefulWidget {
  final UserModel user;

  const AdminTambahBan({Key? key, required this.user}) : super(key: key);

  @override
  State<AdminTambahBan> createState() => _AdminTambahBanState();
}
